...
class WebSettings {
  ...
  @override
  String toString() {
    return 'WebSettings(hasNavigationDelegate: $hasNavigationDelegate, debuggingEnabled: $debuggingEnabled, gestureNavigationEnabled: $gestureNavigationEnabled, userAgent: $userAgent)';
  }
}
